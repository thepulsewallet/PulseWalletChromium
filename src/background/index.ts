...
Sentry.init({
  dsn:
    'https://ca3db553e2407677e1cb280f2404179a@o4506217433071616.ingest.sentry.io/4506217609953280',
...
//   icon.href = 'https://thepulsewallet.org/images/logo.svg';
//   icon.rel = 'icon';
//   head?.appendChild(icon);
//   const name = document.createElement('meta');
//   name.name = 'name';
//   name.content = 'Pulse Wallet';
